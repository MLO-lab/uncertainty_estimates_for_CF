...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes, nf, input_size, dropout_prob=0.5):
    ...
    def _make_layer(self, block, planes, num_blocks, stride):
        ...
        for stride in strides:
            layers.append(block(self.in_planes, planes, stride, self.dropout_prob))
...
def SlimResNet18MC(nclasses, input_size=(3, 32, 32), nf=20, dropout_prob=0.5):
    """Slimmed ResNet18 with dropout."""
    return ResNet(BasicBlock, [2, 2, 2, 2], nclasses, nf, input_size, dropout_prob)